          ...
          {mode === 'login' && (
            <div className="mt-5 pt-5 border-t border-border">
              <p className="text-[11px] text-muted-foreground text-center leading-relaxed">
                Cont demo client: <span className="font-mono font-semibold">denis.petraru@gmail.com</span> / <span className="font-mono font-semibold">parola123</span>
                <br />
                Cont demo admin: <span className="font-mono font-semibold">admin@jocafe.ro</span> / <span className="font-mono font-semibold">admin123</span>
              </p>
            </div>
          )}
        </div>
